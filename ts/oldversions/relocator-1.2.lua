...
function relocator(subs, sel)
	dialog_config=
	{
		...
		items={"round numbers","reverse move","move2fbf","FReeZe","rotate 180","flip hor.","flip vert."},value="round numbers"},
	...
	if pressed=="Metamorphosis" then 
	    if res.mod=="move2fbf" then movetofbf(subs, sel) else modifier(subs, sel) end
	end
