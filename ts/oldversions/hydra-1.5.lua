...
function hh9(subs, sel)
	...
	if res["transtags"] then transform=transform..res["moretags"] end
...
function konfig(subs, sel)
	dialog_config=
	{
	    ...
	    {	x=0,y=9,width=5,height=1,class="checkbox",name="trans",
		label="transform [in transform mode all applicable selected tags go after \\t]",value=false},
	    ...
	    {	x=4,y=10,width=2,height=1,class="checkbox",name="tend",label="Count from the end",value=false},
	    {	x=4,y=11,width=1,height=1,class="label",label="        Accel:"},
	    {	x=5,y=11,width=1,height=1,class="floatedit",name="accel",value=1 },
	    {	x=0,y=11,width=1,height=1,class="checkbox",name="transtags",label="Additional tags:"},
	    {	x=1,y=11,width=3,height=1,class="edit",name="moretags",value="\\" },
	    ...
	    {	x=3,y=1,width=1,height=1,class="floatedit",name="bord2",min=0 },
	    {	x=3,y=2,width=1,height=1,class="floatedit",name="shad2",min=0 },
	    {	x=3,y=3,width=1,height=1,class="floatedit",name="fs2",value=50,min=1 },
	    {	x=3,y=4,width=1,height=1,class="floatedit",name="spac2", },
	    {	x=3,y=5,width=1,height=1,class="floatedit",name="blur2",value=0.6,min=0.4 },
	    ...
	    {	x=5,y=7,width=1,height=1,class="floatedit",name="fadout",min=0 },
	    ...
	    {	x=5,y=1,width=1,height=1,class="floatedit",name="xbord2",value="",min=0 },
	    {	x=5,y=2,width=1,height=1,class="floatedit",name="ybord2",value="",min=0 },
	    {	x=5,y=3,width=1,height=1,class="floatedit",name="xshad2",value="" },
	    {	x=5,y=4,width=1,height=1,class="floatedit",name="yshad2",value="" },
	    {	x=5,y=5,width=1,height=1,class="floatedit",name="fax2",value=0.05 },
	    {	x=5,y=6,width=1,height=1,class="floatedit",name="fay2",value=0.05 },
	    
	    {	x=6,y=1,width=1,height=1,class="checkbox",name="layer",label="layer",value=false},
	    {	x=6,y=7,width=1,height=1,class="checkbox",name="q2",label="\\q2",value=false },
	    {	x=6,y=2,width=1,height=1,class="checkbox",name="arfa",label="\\alpha",value=false },
	    
	    {	x=6,y=3,width=1,height=1,class="checkbox",name="arf1",label="\\1a",value=false },
	    {	x=6,y=4,width=1,height=1,class="checkbox",name="arf2",label="\\2a",value=false },
	    {	x=6,y=5,width=1,height=1,class="checkbox",name="arf3",label="\\3a",value=false },
	    {	x=6,y=6,width=1,height=1,class="checkbox",name="arf4",label="\\4a",value=false },
	    
	    {	x=7,y=1,width=1,height=1,class="dropdown",name="layers",
		items={"-5","-4","-3","-2","-1","+1","+2","+3","+4","+5"},value="+1" },
	    {	x=7,y=2,width=1,height=1,class="dropdown",name="alpha",
		items={"00","10","20","30","40","50","60","70","80","90","A0","B0","C0","D0","E0","F0","FF"},value="00" },
	    
	    {	x=7,y=3,width=1,height=1,class="dropdown",name="alph1",
		items={"00","10","20","30","40","50","60","70","80","90","A0","B0","C0","D0","E0","F0","FF"},value="00" },
	    {	x=7,y=4,width=1,height=1,class="dropdown",name="alph2",
		items={"00","10","20","30","40","50","60","70","80","90","A0","B0","C0","D0","E0","F0","FF"},value="00" },
	    {	x=7,y=5,width=1,height=1,class="dropdown",name="alph3",
		items={"00","10","20","30","40","50","60","70","80","90","A0","B0","C0","D0","E0","F0","FF"},value="00" },
	    {	x=7,y=6,width=1,height=1,class="dropdown",name="alph4",
		items={"00","10","20","30","40","50","60","70","80","90","A0","B0","C0","D0","E0","F0","FF"},value="00" },
	    
	} 
	
	pressed, res = aegisub.dialog.display(dialog_config,{"Apply","Cancel"})
	if pressed=="Apply" then hh9(subs, sel) end
