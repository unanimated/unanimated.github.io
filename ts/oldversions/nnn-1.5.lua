...
-- Third function shifts linebreaks back and is disabled by default. Uncomment the last line of this script to enable it. (Delete the "--".)
...
--aegisub.register_macro("Shift Linebreak Back", script_description, backshift)