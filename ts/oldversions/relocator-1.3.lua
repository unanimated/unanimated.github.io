...
function joinfbflines(subs, sel)
	...
	if line.effect=="1" then line.end_time=endtime line.effect="" subs[sel[i]]=line else subs.delete(sel[i]) end
    end
end
...
function relocator(subs, sel)
	dialog_config=
	{
		...
		items={"round numbers","reverse move","move2fbf","join fbf lines","FReeZe","rotate 180","flip hor.","flip vert.","letterbreak","wordbreak"},value="round numbers"},
