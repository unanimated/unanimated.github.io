...
hh1=
{
    {x=0,y=0,width=6,height=1,class="label",label=hydraulics[hr], },
...
hh2={
    {x=7,y=0,width=2,height=1,class="label",name="info",label="Selected lines: "..#sel },
...
hh3={
	...
	hhh={x=0,y=14,width=8,height=1,class="dropdown",name="herp",items={"HELP (scroll/click to read)",
