...
function colorize(subs, sel)
	...
	{x=0,y=5,width=5,height=1,class="dropdown",name="mode",
		items={"colorize letter by letter","\\c -> \\3c (match outline to primary)","\\3c -> \\c (match primary to outline)"},value="colorize letter by letter"},
	} 	
