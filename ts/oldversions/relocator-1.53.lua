...
function relocator(subs, sel)
	dialog_config=
	{
		...
		items={"round numbers","reverse move","move2fbf","join fbf lines","killmovetimes","fullmovetimes","fulltranstimes","FReeZe","rotate 180","flip hor.","flip vert.","negative rot","letterbreak","wordbreak"},value="round numbers"},
