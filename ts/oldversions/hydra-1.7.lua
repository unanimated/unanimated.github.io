...
script_version = "1.7"	-- nuked \t 'additional tags' checkbox, transform checkbox, added settings
...
function konfig(subs, sel)
	dialog_config=
	{
	    ...
	    {	x=0,y=11,width=1,height=1,class="label",name="transtags",label="Additional tags:"},
	    ...
	    {	x=5,y=5,width=1,height=1,class="floatedit",name="fax2",value=default_fax },
	    {	x=5,y=6,width=1,height=1,class="floatedit",name="fay2",value=default_fay },
