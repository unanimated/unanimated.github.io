...
function copyc(subs, sel)	-- clip etc
	...
	local text=subs[i].text
	      ...
	      if x~=#sel and res.copymode=="raw" then
	      copyclip=copyclip..line.raw.."\n"
	      end
	      if x==#sel and res.copymode=="raw" then
	      copyclip=copyclip..line.raw
	      end
...
function multicopy(subs, sel)
	...
	items={"tags","text","all","------","export CR for pad","------","clip","position","blur","border","\\1c","\\3c","\\4c","alpha","\\fscx","\\fscy","------","layer","duration","raw"}},
	...
	items={"all","clip","position","blur","border","\\1c","\\3c","\\4c","alpha","\\fscx","\\fscy","\\fscx\\fscy","any tag","------","layer","duration","raw"}},
	...
	if pressed=="Copy" then    
	    ...
	    or res.copymode=="layer" or res.copymode=="duration" or res.copymode=="raw" then copyc(subs, sel) end	
