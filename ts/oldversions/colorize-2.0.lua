...
match_config=
	...
	{x=4,y=0,width=1,height=1,class="label",label="copy outline\nto shadow"},
	{x=6,y=0,width=1,height=1,class="label",label="switch primary\nand outline"},
	}
if pressed=="Match Colours" then
	press,rez=aegisub.dialog.display(match_config,{"c --> 3c","3c --> c","3c --> 4c","c <--> 3c","Cancel"},{close='Cancel'})
...
function colorize(subs, sel)
	...
	{x=7,y=0,width=2,height=1,class="intedit",name="R",value=0,min=-10,max=60},
	{x=6,y=1,width=1,height=1,class="label",label="Green: "},
	{x=7,y=1,width=2,height=1,class="intedit",name="G",value=0,min=-10,max=60},
	{x=6,y=2,width=1,height=1,class="label",label="Blue: "},
	{x=7,y=2,width=2,height=1,class="intedit",name="B",value=0,min=-10,max=60},
	{x=6,y=4,width=1,height=1,class="label",label="Brightness:"},
	{x=7,y=4,width=2,height=1,class="intedit",name="bright",value=0,min=-10,max=60},
