...
function relocator(subs, sel)
	dialog_config=
	{
		...
		items={"round numbers","move2fbf","join fbf lines","killmovetimes","fullmovetimes","fulltranstimes","set origin","FReeZe","rotate 180","flip hor.","flip vert.","negative rot","letterbreak","wordbreak"},value="round numbers"},
