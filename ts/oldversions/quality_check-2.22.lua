...
tdura=0		tlength=0	tcps=0		report=""	styles=""	misstyles=""	fontlist=""	fontable={}
...
function konfig(subs, sel)
	...
	{x=1,y=10,width=1,height=1,class="checkbox",name="read",label="Check for hard-to-read lines",value=true},
	{x=1,y=11,width=1,height=1,class="checkbox",name="noread",label="Check for unreadable lines",value=true},
	{x=1,y=12,width=1,height=1,class="checkbox",name="redundant",label="Check for redundant tags",value=true},
	{x=1,y=13,width=1,height=1,class="checkbox",name="failita",label="Check for bad italics",value=true},
	{x=1,y=14,width=1,height=1,class="checkbox",name="mistyle",label="Check for missing styles",value=true},
	{x=1,y=15,width=1,height=1,class="checkbox",name="dlayer",label="Check dialogue layer",value=true},
	{x=1,y=16,width=1,height=1,class="checkbox",name="halfsec",label="Check for dialogue lines under 0.5s",value=true,hint="bur over 1 frame and over 8 characters"},
	...
	{x=1,y=18,width=3,height=1,class="label",label="This is to help you spot mistakes. If you're using this INSTEAD of QC, you're dumb."},
