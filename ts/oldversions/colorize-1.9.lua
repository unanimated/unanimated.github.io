...
function colorize(subs, sel)
	...
	{x=0,y=5,width=6,height=1,class="dropdown",name="mode",
		items={"colorize letter by letter","repeat with last settings","\\c -> \\3c (match outline to primary)","\\3c -> \\c (match primary to outline)","\\c <--> \\3c (switch primary and border)","adjust RGB / brightness"},value="colorize letter by letter"},
	} 	
