...
--[[	Instructions
 ...
 Org to Fax: calculates \fax from the line between \pos and \org coordinates. (Only works if fscx==fscy.)
 Clip to Fax: calculates \fax from the line between the first 2 points of a vectorial clip. (Only works if fscx==fscy.)
...
function relocator(subs, sel)
	dialog_config=
	{
	    ...
	    {x=0,y=1,width=1,height=1,class="dropdown",name="posi",items={"Align X","Align Y","org to fax","clip to fax"},value="Align X",},
