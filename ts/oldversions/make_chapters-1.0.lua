...
-- MARKER: For a line to be used for chapters, it has to be marked with "chapter"/"chptr"/"chap" in actor/efefct field (depending on settings) 
--	or the same 3 options as a separate comment, ie. {chapters} etc.
...
autogenerate_intro=false		-- options: true / false
