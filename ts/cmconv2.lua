...
script_name = "BT.709 -> BT.601 Color Converter"
script_description = "Change colors from BT.709 to BT.601."
script_name_2 = "BT.709 -> BT.601 Global Color Converter"
script_description_2 = "Globally change colors from BT.709 to BT.601."
script_author = "Daiz"
...
function replace(colorstring)
  ...
  nr, ng, nb = cm_conv(r, g, b, Rec709, Rec601)
...
function correct(subs, sel, active)
  ...
  aegisub.set_undo_point("BT.709->BT.601 Color Convert")
...
function correct_global(subs, sel, active)
  ...
  for i = 1, #subs do
    ...
    if l.class == "style" then
      ...
      local nr, ng, nb = cm_conv(r, g, b, Rec709, Rec601)
  ...
  aegisub.set_undo_point("BT.709->BT.601 Global Color Convert")
