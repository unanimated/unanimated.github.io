...
unconfig={
	...
	{x=1,y=15,width=2,height=1,class="dropdown",name="stuff",items={"lua replacer","perl replacer","jump to next","alpha shift","add comment","make comments visible","switch commented/visible","honorificslaughterhouse","convert framerate"},value="lua replacer"},
